...
public class UserRepository implements IUserRepository {
    ...
    private static final String SELECT_USERS_SQL_PROCEDURE = "call select_all_users();";
    private static final String EDIT_USERS_SQL_PROCEDURE = "call edit_user(?,?,?,?);";
    private static final String DELETE_USERS_SQL_PROCEDURE = "call delete_user(?);";
...
//        ------------store procedure-----
        ...
        try (Connection connection = BaseRepository.getConnect();
             CallableStatement callableStatement = connection.prepareCall(SELECT_USERS_SQL_PROCEDURE);
        ) {
//             Step 3: Thực thi truy vấn hoặc cập nhật truy vấn
...
//             PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL);) {
        ...
        try (Connection connection = BaseRepository.getConnect();
             CallableStatement statement = connection.prepareCall(EDIT_USERS_SQL_PROCEDURE);) {
...
//             PreparedStatement statement = connection.prepareStatement(DELETE_USERS_SQL);) {
        try (Connection connection = BaseRepository.getConnect();
             CallableStatement statement = connection.prepareCall(DELETE_USERS_SQL_PROCEDURE);) {
